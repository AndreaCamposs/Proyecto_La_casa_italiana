        	...
        	<div class="col-lg-8">
        		<div class="sticky">
	        		<div class="card">
	        			<div class="card-body">
	        				<div class="row">
		        				<div class="col-md-8"><b>Productos</b></div>
	        		...
	        		<div class="card-body">
		        		<div class="row">
			        		...
			        		<div class="col-md-4">
			        			...
			        			<p class='truncate'> <b><small>Descripción<?php echo $row['description'] ?></small></b></p>
			        			<p> <b><small>Precio Unitario<?php echo number_format($row['price'],2) ?></small></b></p>
