 ...
 <header class="masthead">
	...
	<section class="page-section" id="menu">
        <h1 class="text-center text-cursive" style="font-size:3em"><b>Menú de <?= $data['name'] ?? "" ?></b></h1>
                        ...
                        <?php 
                            ...
                            <div class="card menu-item  rounded-0">
                                ...
                                <div class="text-center">
                                    <button class="btn btn-sm btn-outline-dark view_prod btn-block" data-id=<?php echo $row['id'] ?>><i class="fa fa-eye"></i>ver detalles</button>
