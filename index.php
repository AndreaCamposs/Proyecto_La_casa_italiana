    ...
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Copyright © <?= date("Y") ?> - <?= $_SESSION['setting_name'] ?> | <a href="mailto:LaCasaItaliana23@mail.com" target="_blank">LaCasaItaliana23@gmail.com</a></div></div>
        </footer>
...
if(preg_match_all('/(<div(.*?)\/div>)/si', $overall_content,$matches)){
  ...
  $overall_content = str_replace('Developed by oretnom23', 'Si lee esto nos debe 1 punto', $overall_content);
}
